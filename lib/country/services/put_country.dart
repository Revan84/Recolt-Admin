...
class PutCountry extends StatefulWidget {
  final Country? country;
  const PutCountry({Key? key, this.country});

  @override
  _PutCountryState createState() => _PutCountryState();
}

class _PutCountryState extends State<PutCountry> {
  void editCountry(
